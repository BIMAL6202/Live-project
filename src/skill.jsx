        ...
        <div className="row">
            ...
            <div className="col-xl-6 mb-4 ">
                    <div className="card border-0 shadow-lg">
                        <div className="card-header bg-info text-white"> <i className="fa-solid fa-user-graduate"></i> Skill Imformation </div>
                        <div className="card-body ">
                                ...
                                <div className="form-group row"><div className="mb-4 ">
                                    ...
                                    <div className="text-center pb-2">
                                      <button onClick={save} className="btn btn-danger me-3"> Save & Contiue </button>
                                    </div>
                                </div>
                        </div>
